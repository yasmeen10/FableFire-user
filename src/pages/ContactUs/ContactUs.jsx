      ...
      <div class="grid grid-cols-2 ml-[190px]">
        <form class="max-w-sm mt-[88px]">
          ...
          <p className="w-[320px] text-[#735F39] mt-[15px]">
            feel free to contact us any time. we will get back to you as we can!
          </p>
          <div class="mb-5 mt-[25px]">
            <input
              type="name"
              id="name"
              class="shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5  dark:placeholder-[#735F39] "
              placeholder="Name"
              required
            />
          </div>
          ...
          <button
            type="submit"
            class="text-white bg-[#A68877] hover:bg-[#B99885] focus:ring-4 focus:outline-none font-medium rounded-md text-sm px-5 py-2.5 text-center w-[385px]"
          >
            Send
          </button>
        </form>
        ...
        <div className="bg-[#D6CCC2] h-[350px] w-96 p-4 rounded-md mt-[100px]">
          ...
          <ul className="flex ml-14">
            <li>
              <svg
                class="w-6 h-6 text-[#210F04] dark:text-white mt-9"
                aria-hidden="true"
          ...
          <ul className="flex ml-14">
            <li>
              <svg
                class="w-6 h-6 text-[#210F04] dark:text-white mt-7"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
