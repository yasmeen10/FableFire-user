...
const SwiperComponent = ({
  ...
  const showArrowsStatus = Boolean.includes(showArrows)
    ? showArrows
    : Boolean[0];
  ...
  function removeCarouselItems() {
    ...
    document
      .getElementById(prop.right_2)
      .classList.remove("carousel____right_2");
        ...
        >
          {image.title !== "" ? (
            <div
              ...
              className={`carousel_____image-overlay carousel_____image-overlay-leave top-[20px] ${overlayClassName}`}
